...
import io.github.solcott.marineapi.nmea.sentence.Alm
import io.github.solcott.marineapi.nmea.sentence.Apa
...
import io.github.solcott.marineapi.nmea.sentence.Bww
...
import io.github.solcott.marineapi.nmea.sentence.Fsi
...
import io.github.solcott.marineapi.nmea.sentence.Grs
...
import io.github.solcott.marineapi.nmea.sentence.Hfb
import io.github.solcott.marineapi.nmea.sentence.Hsc
import io.github.solcott.marineapi.nmea.sentence.Htc
import io.github.solcott.marineapi.nmea.sentence.Htd
import io.github.solcott.marineapi.nmea.sentence.Its
...
import io.github.solcott.marineapi.nmea.sentence.Msk
import io.github.solcott.marineapi.nmea.sentence.Mss
...
import io.github.solcott.marineapi.nmea.sentence.Pashr
import io.github.solcott.marineapi.nmea.sentence.Pgrme
import io.github.solcott.marineapi.nmea.sentence.Pgrmm
import io.github.solcott.marineapi.nmea.sentence.Pgrmz
import io.github.solcott.marineapi.nmea.sentence.R00
import io.github.solcott.marineapi.nmea.sentence.Rlm
import io.github.solcott.marineapi.nmea.sentence.Rma
...
import io.github.solcott.marineapi.nmea.sentence.Sfi
import io.github.solcott.marineapi.nmea.sentence.Stalk
import io.github.solcott.marineapi.nmea.sentence.Stn
import io.github.solcott.marineapi.nmea.sentence.Tds
import io.github.solcott.marineapi.nmea.sentence.Tfi
import io.github.solcott.marineapi.nmea.sentence.Ths
import io.github.solcott.marineapi.nmea.sentence.Tlb
import io.github.solcott.marineapi.nmea.sentence.Tll
import io.github.solcott.marineapi.nmea.sentence.Tpc
import io.github.solcott.marineapi.nmea.sentence.Tpr
import io.github.solcott.marineapi.nmea.sentence.Tpt
...
import io.github.solcott.marineapi.nmea.sentence.Vdo
...
import io.github.solcott.marineapi.nmea.sentence.Wnc
...
import io.github.solcott.marineapi.nmea.sentence.Xtr
import io.github.solcott.marineapi.nmea.sentence.Zda
import io.github.solcott.marineapi.nmea.sentence.Zfo
...
private constructor(private val factories: Map<String, SentenceFactory>) {
  ...
  public companion object {
    ...
    public val Default: SentenceRegistry =
      SentenceRegistry(
        mapOf(
          Aam.ID to SentenceFactory(Aam::from),
          Alm.ID to SentenceFactory(Alm::from),
          Apa.ID to SentenceFactory(Apa::from),
          Apb.ID to SentenceFactory(Apb::from),
          Bod.ID to SentenceFactory(Bod::from),
          Bwc.ID to SentenceFactory(Bwc::from),
          Bwr.ID to SentenceFactory(Bwr::from),
          Bww.ID to SentenceFactory(Bww::from),
          Cur.ID to SentenceFactory(Cur::from),
          Dbk.ID to SentenceFactory(Dbk::from),
          Dbs.ID to SentenceFactory(Dbs::from),
          ...
          Fsi.ID to SentenceFactory(Fsi::from),
          ...
          Grs.ID to SentenceFactory(Grs::from),
          ...
          Hfb.ID to SentenceFactory(Hfb::from),
          Hsc.ID to SentenceFactory(Hsc::from),
          Htc.ID to SentenceFactory(Htc::from),
          Htd.ID to SentenceFactory(Htd::from),
          Its.ID to SentenceFactory(Its::from),
          Mda.ID to SentenceFactory(Mda::from),
          Mhu.ID to SentenceFactory(Mhu::from),
          Mmb.ID to SentenceFactory(Mmb::from),
          Msk.ID to SentenceFactory(Msk::from),
          Mss.ID to SentenceFactory(Mss::from),
          ...
          Pashr.ID to SentenceFactory(Pashr::from),
          Pgrme.ID to SentenceFactory(Pgrme::from),
          Pgrmm.ID to SentenceFactory(Pgrmm::from),
          Pgrmz.ID to SentenceFactory(Pgrmz::from),
          R00.ID to SentenceFactory(R00::from),
          Rlm.ID to SentenceFactory(Rlm::from),
          Rma.ID to SentenceFactory(Rma::from),
          ...
          Sfi.ID to SentenceFactory(Sfi::from),
          Stalk.ID to SentenceFactory(Stalk::from),
          Stn.ID to SentenceFactory(Stn::from),
          Tds.ID to SentenceFactory(Tds::from),
          Tfi.ID to SentenceFactory(Tfi::from),
          Ths.ID to SentenceFactory(Ths::from),
          Tlb.ID to SentenceFactory(Tlb::from),
          Tll.ID to SentenceFactory(Tll::from),
          Tpc.ID to SentenceFactory(Tpc::from),
          Tpr.ID to SentenceFactory(Tpr::from),
          Tpt.ID to SentenceFactory(Tpt::from),
          Ttm.ID to SentenceFactory(Ttm::from),
          Txt.ID to SentenceFactory(Txt::from),
          Ubx.ID to SentenceFactory(Ubx::from),
          Vbw.ID to SentenceFactory(Vbw::from),
          Vdm.ID to SentenceFactory(Vdm::from),
          Vdo.ID to SentenceFactory(Vdo::from),
          ...
          Wcv.ID to SentenceFactory(Wcv::from),
          Wnc.ID to SentenceFactory(Wnc::from),
          Wpl.ID to SentenceFactory(Wpl::from),
          Xdr.ID to SentenceFactory(Xdr::from),
          Xte.ID to SentenceFactory(Xte::from),
          Xtr.ID to SentenceFactory(Xtr::from),
          Zda.ID to SentenceFactory(Zda::from),
          Zfo.ID to SentenceFactory(Zfo::from),
          Ztg.ID to SentenceFactory(Ztg::from),
        )
      )
