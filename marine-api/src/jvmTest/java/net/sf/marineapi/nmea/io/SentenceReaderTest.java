...
public class SentenceReaderTest {
	...
	public final static String TEST_DATA = "/data/Navibe-GM720.txt";
	...
	public void setUp() throws Exception {
		stream = getClass().getResourceAsStream(TEST_DATA);
		assertNotNull("Test data not on classpath: " + TEST_DATA, stream);
	...
	public void testSetInputStream() throws Exception {
		InputStream stream = getClass().getResourceAsStream("/data/Garmin-GPS76.txt");
		assertNotNull("Test data not on classpath: /data/Garmin-GPS76.txt", stream);
